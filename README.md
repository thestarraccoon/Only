...
- Для некоторых роутов используется обязательным X-Corporate-ID (например, /register), который должен соответствовать пользователю (директорский токен и директорский заголовок).
...
- Также предполагается, что 1 водитель может работать на 2 и более машинах (не одновременно, а быть закрепленным как водитель).
